...
def classify_intent(state: AgentState) -> dict:
    ...
    prompt = (
        ...
        "- 'Which gold customers have an open ticket?' -> sql\n"
        "- 'Who are the top 5 customers by lifetime spend?' -> sql\n"
        ...
        "- 'What loyalty tier is Sarah Chen and what discount does she get?' -> hybrid\n"
        "- 'Is Emily Torres eligible for free shipping based on her loyalty tier?' -> hybrid\n"
        "- 'Hello!' -> general\n\n"
